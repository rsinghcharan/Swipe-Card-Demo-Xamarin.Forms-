...
namespace SwipeCards.Controls
{
    public partial class CardStackView : ContentView
    {
        ...
        public static BindableProperty CardSelectedCommandProperty = BindableProperty.Create(nameof(CardSelectedCommand), typeof(ICommand), typeof(CardStackView), null);
        public ICommand CardSelectedCommand
        {
            get { return (ICommand)GetValue(CardSelectedCommandProperty); }
            set { SetValue(CardSelectedCommandProperty, value); }
        }
        ...
        public CardStackView()
        {
            ...
            //Set the Card Selected Event 
            tabGesture.Tapped += (ea, sa) =>
            {
                if (CardSelectedCommand != null && itemIndex < ItemsSource.Count)
                    CardSelectedCommand.Execute(ItemsSource[itemIndex]);

            };
            this.GestureRecognizers.Add(tabGesture);
            Setup();
        }
